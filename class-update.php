...
class Update
{
    ...
    public function update_1_15_0()
    {
        ...
        $wpdb->query( "
            update {$wpdb->prefix}money_manager_accounts
                set type = 'crypto' where created_by = " . get_current_user_id() . " AND type = ''
        " );
    }
    ...
    public function update_1_12_0()
    {
        ...
        $entries = $wpdb->get_results( "select * from {$wpdb->usermeta} where created_by = " . get_current_user_id() . " AND meta_key = 'money_manager'" );
